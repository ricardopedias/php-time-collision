...
class ChunksFillablesFromEndOfRangeTest extends TestCase
{
    public function dataTests(): array
    {
        // Range das 12:00 às 13:00
        // Liberado das 12:10 às 12:25 e das 12:35 às 13:00
        ...
        $result[] = [
            ...
            'result' => [
                ...
                1 => [ '2020-11-01 12:35:00', '2020-11-01 13:00:00' ],
            ]
        ];
        ...
        // Com base nos periodos liberados das 12:10 às 12:25 e das 12:35 às 13:00

        $result[] = [
            'from' => [ '2020-11-01 12:10:00', '2020-11-01 13:00:00'], // todos os minutos liberados
            'result' => [
                0 => [ '2020-11-01 12:10:00', '2020-11-01 12:25:00' ],
                1 => [ '2020-11-01 12:35:00', '2020-11-01 13:00:00' ],
            ]
        ...
        $result[] = [
            'from' => [ '2020-11-01 12:15:00', '2020-11-01 13:00:00'], // fim dos minutos liberados
            'result' => [
                0 => [ '2020-11-01 12:15:00', '2020-11-01 12:25:00' ],
                1 => [ '2020-11-01 12:35:00', '2020-11-01 13:00:00' ],
            ]
        ...
        $result[] = [
            'from' => [ '2020-11-01 12:00:00', '2020-11-01 13:00:00'], // fora dos minutos liberados
            'result' => [
                0 => [ '2020-11-01 12:10:00', '2020-11-01 12:25:00' ],
                1 => [ '2020-11-01 12:35:00', '2020-11-01 13:00:00' ],
            ]
    ...
    private function makeRangeObject(): Minutes
    {
        ...
        $rangeObject->mark(new DateTime('2020-11-01 12:35:00'), new DateTime('2020-11-01 13:00:00'), Minutes::ALLOWED);
